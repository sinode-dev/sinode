...
import petsc4py
from grand.lib.recorder import Recorder
...
def main(cmd_opt, rec):
    from grand.lib.grand.data import get_dataset, set_train_val_test_split
    from grand.lib.grand.GNN import GNN
    from grand.lib.grand.GNN_early import GNNEarly
    from grand.lib.grand.best_params import best_params_dict
