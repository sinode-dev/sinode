...
##################
# For torchdiffeq example, run:
#       python3 ODE_Ying.py --method euler
# For pnode example with single precision, run:
...
# For pnode example with double precision, run:
#       python3 ODE_Ying.py --adjoint --pnode --imex --use_dlpack -ts_trajectory_type memory -ts_adapt_type none -ts_arkimex_type 1bee -snes_type ksponly --double_prec
##################
...
# parser.add_argument("--max_nfe", type=int, default=1000000,
